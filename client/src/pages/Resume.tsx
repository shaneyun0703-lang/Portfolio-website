        ...
        <div className="resume-content px-16 pt-12 pb-0">
          ...
          <div className="mt-2.5">
            ...
            <ul className="text-[0.72rem] leading-[1.55] mt-1 space-y-0.5">
              <li className="flex gap-1.5"><span className="shrink-0">•</span><span>Drove design for Meta's <strong>unified ad campaign builder</strong> — merging two separate eCommerce flows (static ads and catalog-based dynamic ads) into a single AI-automated experience used by millions of businesses</span></li>
              ...
              <li className="flex gap-1.5 pl-3"><span className="shrink-0 text-[#aaa]">–</span><span>Led design for integrating <strong>product media into the new creative framework</strong> — enabling catalog-based advertisers to leverage the unified ads creative experience for the first time, bridging product feeds with the broader multimedia ad builder</span></li>
              ...
              <li className="flex gap-1.5"><span className="shrink-0">•</span><span>Led design for <strong>WhatsApp Ads</strong> — scaled the product from 2 to 5 of Meta's 6 marketing objectives, navigated cross-org alignment between WhatsApp and Ads leadership, shipped globally to 100% rollout hitting all topline revenue goals</span></li>
          ...
          <div>
            ...
            <ul className="text-[0.72rem] leading-[1.55] mt-1 space-y-0.5">
              ...
              <li className="flex gap-1.5"><span className="shrink-0">•</span><span>Redesigned the <strong>Apple privacy framework experience</strong> (SKAdNetwork) — simplified campaign creation (3.24% faster), resolved error patterns affecting 175K+ advertisers ($2.4M past-90-day revenue)</span></li>
