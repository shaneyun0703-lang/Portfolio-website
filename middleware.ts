...
<head>
  ...
  <style>
    *{box-sizing:border-box;margin:0;padding:0}
    ...
    .disp{width:100%;padding:14px 48px 14px 16px;border-radius:7px;font-size:15px;outline:none;
...
<body>
  ...
  (function(){
    try{
      ...
      disp.placeholder='';sub.textContent=String.fromCharCode(160);foot.innerHTML='';
      ...
      setTimeout(function(){typeP(disp,'enter password',72,true,function(){setTimeout(function(){typeP(sub,'enter',95,false,function(){setTimeout(function(){typeFoot(48);},400);});},300);});},2350);
